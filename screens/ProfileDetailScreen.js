          ...
          <>
            <View>
              ...
              <View style={{marginVertical: 15}}>
                ...
                <View>
  {/* Ensure the imageUrls array exists and has valid content */}
  {route?.params?.currentProfile?.imageUrls?.slice(1, 3).map((item, index) => (
    item ? ( // Only render if the URL (item) is not empty
    ...
    ) : null // Do not render anything if the image URL is invalid
  ))}
</View>
      ...
      <View key={index} style={{ marginVertical: 10 }}>
        ...
        {/* <View
          ...
          <AntDesign name="hearto" size={25} color="#C5B358" />
                ...
                <View style={{marginVertical: 15, flexDirection:"column" ,gap:20}}>
                  {route?.params?.currentProfile?.prompts.slice(2, 4).map(prompt => (
                    <>
                      <View
                        key={prompt.id}
                        style={{
